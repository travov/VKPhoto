...
import com.example.vkphoto.requests.VKFavePhotosRequest;
...
public class FavoritePresenter extends Presenter {
    ...
    public FavoritePresenter(Fragment fragment, ViewGroup view) {
        super(fragment, view);
        offset = 0;
        visibleThreshold = 10;
        previousTotal = 0;
        rv = view.findViewById(R.id.fave_recycler);
    ...
    public void getFave() {
        VKFavePhotosRequest req = new VKFavePhotosRequest(offset, COUNT);
        ...
        VK.execute(req, new VKApiCallback<RequestResult<VKPhoto>>() {
            ...
            public void success(RequestResult<VKPhoto> result) {
                Log.i(TAG, "get fave photos with offset " + offset);
            ...
            public void fail(@NotNull Exception e) {
                Toast.makeText(view.getContext(), fragment.getString(R.string.error_fave_photos), Toast.LENGTH_SHORT).show();
